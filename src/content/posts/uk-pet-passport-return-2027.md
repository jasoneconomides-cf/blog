...
GOV.UK guidance says pet owners travelling from Great Britain to an EU country generally need an animal health certificate unless they have another valid travel document accepted under the rules.

## What about EU pet passports?

GOV.UK published updated guidance in 2026 explaining that Great Britain residents should get an animal health certificate when travelling from Great Britain to an EU country. It also warned that EU pet passports are for people whose main home is in the EU and should not be used by people who only have holiday homes in the EU or visit seasonally.
...
1. Check GOV.UK before booking travel.
2. Ask your vet whether they can issue animal health certificates.
3. Make sure your pet is microchipped before the rabies vaccination used for travel.
4. Leave enough time for rabies vaccination waiting periods and AHC appointments.
5. Check the return rules for bringing your pet back to Great Britain.
